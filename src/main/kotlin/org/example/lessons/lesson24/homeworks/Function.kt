...
//1
fun myFunction(flag: Boolean, action: (String) -> Unit): Int {
    if (flag) {
...
// 2
fun Int.applyToString(fn: Int.(String) -> List<String>): List<String> {
    return this.fn("hello")
}

// 3
fun <T, R> T.applyExtension(fn: T.() -> R): R {
    return this.fn()
}

// 4
fun makeStringSupplier(text: String): () -> String {
    return { text }
}

// 5
fun <T> T.makeFunction(): (String) -> T {
    return { this }
}
