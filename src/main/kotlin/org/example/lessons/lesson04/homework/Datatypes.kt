...
class Datatypes {
    ...
    // val v6 = FALSE - Boolean has only true or false lowcase
    val v7: Char = 'c'
    val v8: Int = 500
    ...
    val v19: Float = 5.75f
    // val v20 = `1.414` - Char has only 1 symbol
    ...
    // val v30 = FALSE - Boolean has only true or false lowcase
    val v31: Double = 0.007
    // val v32 = “🤯” - No smiles as used symbols
    val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
    // val v34 = ‘65535’ - Char has only 1 symbol
    ...
    //val v44 = TRUE - Boolean has only true or false lowcase
    ...
    val v54: Map<String, Int> = mapOf("название стартапа" to 2323)
    ...
    val v56: List<String> = listOf("ccc", "ssdd", "sdsd")
}